        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
          <thead>
            <tr style="background-color: #f3f4f6;">
              ...
              <th style="padding: 12px; text-align: right; border-bottom: 2px solid #e5e7eb;">Display Quantity</th>
          ...
          <tbody>
            ${inventoryData.map(item => `
              <tr>
                ...
                <td style="padding: 12px; border-bottom: 1px solid #e5e7eb; text-align: right;">${item.displayQuantity}</td>
